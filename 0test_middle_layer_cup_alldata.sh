...
python scripts/eval_arx5.py \
    ...
    -o data/experiments/0128-cup_wild_vit_l_1img-eval \
...
#     -o data/experiments/0128-dataall_umi_cup-dataaugtype3-lr1e-5-2-bluecup-16diffstep-eval \
#     --different_history_freq \
#     --policy_port 8768 --frequency 5 --steps_per_inference 4 \
#     --task_name cup \
    # --match_dataset_path data/experiments/0128-dataall_umi_cup-dataaugtype3-lr1e-5-2-bluecup-eval \
    # --match_episode 0 \
